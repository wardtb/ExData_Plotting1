...
plot(df$DT,df$Voltage,col = "black", type = "l",xlab = "datetime",ylab = "Voltage")
...
plot(df$DT,df$Global_reactive_power,col = "black", type = "l",xlab = "datetime",ylab = "Global_reactive_power")
